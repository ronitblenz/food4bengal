...
<a href="https://www.figma.com/file/DOCWexVCbucG3KRWxj9k2S/Untitled?type=design&node-id=0-1&mode=design&t=DeIuvPAmQzDryPfy-0">System Design</a>


<img src = "https://github.com/diyaaPurbali/food4bengalpics/assets/113189274/428b4198-7275-4f95-b127-ef39d2eea1d9" height=400px width=800px><br>

          -Full Stack Mern Application[Prototype system Design]



<a href="https://www.figma.com/proto/IKczUSrxuCoKhIxZ2SVrry/Hack4bengal-wireframe?type=design&node-id=304-2&t=j1ElQnicZofN5tlF-0&scaling=scale-down&page-id=0%3A1">Our Prototype</a>

 <img src = "https://github.com/diyaaPurbali/food4bengalpics/assets/113189274/14955d02-fa36-472e-a8cf-1e1f1676b94b" height=400px width=800px><br>
...
&nbsp; 
- [x] Landing page
- [x] Aadhar Verification page
- [x] Sign up page
- [x] Profile page
- [x] Select the category of food to donate
- [x] meal type and Quantity of the specific food
- [x] save the address and contact details
- [x] Verified NGO page and their details
- [x] page to select a NGO or Hunger spot
- [x] food and volunteer required page 
- [x] All details for where the food required and when
- [x] Choose to be a volunteer or a donor
- [x] delivery on its way 
- [x] pickup the food to distribute
